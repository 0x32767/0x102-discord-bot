...
class EncryptionDropdown(Select):
    def __init__(self: "EncryptionDropdown", msg: str):
        super().__init__(
            ...
            min_values=1,
            options=[
                SelectOption(label="hexadecimal encode", value="hexadecimal encode", description="hexadecimal encode"),
                SelectOption(label="caesar cipher", value="caesar cipher", description="caesar cipher"),
                SelectOption(label="binary encode", value="binary encode", description="binary encode"),
